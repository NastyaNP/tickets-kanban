...
module.exports.models = {
    ...
    createdAt: { type: "ref", autoCreatedAt: true, columnName: "created_date", columnType: "timestamptz" },
    updatedAt: { type: "ref", autoUpdatedAt: true, columnName: "updated_date", columnType: "timestamptz" },
    ...
    attributes: {
        createdAt: { type: "ref", autoCreatedAt: true, columnType: "timestamptz" },
        updatedAt: { type: "ref", autoUpdatedAt: true, columnType: "timestamptz" },
        id: { type: "number", unique: true, autoIncrement: true, },
        //--------------------------------------------------------------------------
        //  /\   Using MongoDB?
    ...
    dataEncryptionKeys: {
        default: "VLMmVNh5GEHqhrH5vx5hU0QKvDBuzv0vrj8CkImxBAo="
    },
